...
Revision ID: c14e93f69c13
Revises: 
Create Date: 2026-06-27 11:16:58.073943
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('ADMIN', 'DOCTOR', 'PATIENT', name='user_roles'), nullable=True),
    ...
    sa.Column('hospital_branch', sa.String(length=100), nullable=True),
    ...
    sa.Column('gender', sa.Enum('MAN', 'WOMAN', name='genders'), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('user_id')
    )
