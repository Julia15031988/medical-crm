...
Revision ID: 7146be507190
Revises: 
Create Date: 2026-07-05 07:21:31.956324
...
def upgrade() -> None:
    ...
    sa.Column('hospital_branch', sa.String(length=100), nullable=False),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('gender', sa.Enum('MAN', 'WOMAN', name='genders'), nullable=False),
